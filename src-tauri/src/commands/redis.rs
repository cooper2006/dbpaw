...
async fn connection_form(state: &State<'_, SharedAppState>, id: i64) -> Result<ConnectionForm, String> {
  let local_db = {
...
async fn connection_form_direct(state: &AppState, id: i64) -> Result<ConnectionForm, String> {
  let local_db = {
    let lock = state.local_db.lock().await;
    lock.clone()
  };
...
pub async fn redis_list_databases_direct(
  state: &AppState,
  id: i64,
) -> Result<Vec<RedisDatabaseInfo>, String> {
  let form = connection_form_direct(state, id).await?;
  redis::test_connection(&form).await?;
  redis::list_databases(&form)
}
...
pub async fn redis_scan_keys_direct(
  state: &AppState,
  id: i64,
  database: Option<String>,
  cursor: Option<u64>,
...
pub async fn redis_get_key_direct(
  state: &AppState,
  id: i64,
  database: Option<String>,
  key: String,
...
pub async fn redis_set_key_direct(
  state: &AppState,
  id: i64,
  database: Option<String>,
  payload: RedisSetKeyPayload,
...
pub async fn redis_update_key_direct(
  state: &AppState,
  id: i64,
  database: Option<String>,
  payload: RedisSetKeyPayload,
...
pub async fn redis_delete_key_direct(
  state: &AppState,
  id: i64,
  database: Option<String>,
  key: String,
...
pub async fn redis_rename_key_direct(
  state: &AppState,
  id: i64,
  database: Option<String>,
  old_key: String,
...
pub async fn redis_get_key_page_direct(
  state: &AppState,
  id: i64,
  database: Option<String>,
  key: String,
...
pub async fn redis_set_ttl_direct(
  state: &AppState,
  id: i64,
  database: Option<String>,
  key: String,
...
pub async fn redis_execute_raw_direct(
  state: &AppState,
  id: i64,
  database: Option<String>,
  command: String,
